#include "cvls_poly_dim3_sgd.h"

namespace pbrt {

void Poly_Order0_Dim3_luminance_SGD::reset() {
    X.setZero();
}
float Poly_Order0_Dim3_luminance_SGD::G() const {
    float v = X[0];
    int div[1];
    div[0] = 1;
    for (int i = 1; i < 1; ++i) {
...
float Poly_Order0_Dim3_luminance_SGD::g( const Eigen::VectorXd &s) const {
    float v = X[0];
    float c[1];
    c[0] = 1.0;
    for (int i = 1; i < 1; ++i) {
...
void Poly_Order0_Dim3_luminance_SGD::sgd( const Eigen::VectorXd &s, Float v, const Float lr) {
    float c[1];
    c[0] = 1.0;
    Float e = (g(s) - v);
    for (int i = 0; i < 1; ++i) {
...
float Poly_Order0_Dim3_luminance_SGD::g_then_sgd( const Eigen::VectorXd &s, Float v, const Float lr) {
    // Evaluation g
    float g = X[0];
    float c[1];
    c[0] = 1.0;
...
void Poly_Order1_Dim3_luminance_SGD::reset() {
    X.setZero();
}
float Poly_Order1_Dim3_luminance_SGD::G() const {
    float v = X[0];
    int div[4];
    div[0] = 1;
    div[1] = 2;
...
float Poly_Order1_Dim3_luminance_SGD::g( const Eigen::VectorXd &s) const {
    float v = X[0];
    float c[4];
    c[0] = 1.0;
    c[1] = s[0];
...
void Poly_Order1_Dim3_luminance_SGD::sgd( const Eigen::VectorXd &s, Float v, const Float lr) {
    float c[4];
    c[0] = 1.0;
    c[1] = s[0];
    c[2] = s[1];
...
float Poly_Order1_Dim3_luminance_SGD::g_then_sgd( const Eigen::VectorXd &s, Float v, const Float lr) {
    // Evaluation g
    float g = X[0];
    float c[4];
    c[0] = 1.0;
...
void Poly_Order2_Dim3_luminance_SGD::reset() {
    X.setZero();
}
float Poly_Order2_Dim3_luminance_SGD::G() const {
    float v = X[0];
    int div[10];
    div[0] = 1;
    div[1] = 2;
...
float Poly_Order2_Dim3_luminance_SGD::g( const Eigen::VectorXd &s) const {
    float v = X[0];
    float c[10];
    c[0] = 1.0;
    c[1] = s[0];
...
void Poly_Order2_Dim3_luminance_SGD::sgd( const Eigen::VectorXd &s, Float v, const Float lr) {
    float c[10];
    c[0] = 1.0;
    c[1] = s[0];
    c[2] = s[1];
...
float Poly_Order2_Dim3_luminance_SGD::g_then_sgd( const Eigen::VectorXd &s, Float v, const Float lr) {
    // Evaluation g
    float g = X[0];
    float c[10];
    c[0] = 1.0;
...
void Poly_Order3_Dim3_luminance_SGD::reset() {
    X.setZero();
}
float Poly_Order3_Dim3_luminance_SGD::G() const {
    float v = X[0];
    int div[20];
    div[0] = 1;
    div[1] = 2;
...
float Poly_Order3_Dim3_luminance_SGD::g( const Eigen::VectorXd &s) const {
    float v = X[0];
    float c[20];
    c[0] = 1.0;
    c[1] = s[0];
...
void Poly_Order3_Dim3_luminance_SGD::sgd( const Eigen::VectorXd &s, Float v, const Float lr) {
    float c[20];
    c[0] = 1.0;
    c[1] = s[0];
    c[2] = s[1];
...
float Poly_Order3_Dim3_luminance_SGD::g_then_sgd( const Eigen::VectorXd &s, Float v, const Float lr) {
    // Evaluation g
    float g = X[0];
    float c[20];
    c[0] = 1.0;
...
void Poly_Order4_Dim3_luminance_SGD::reset() {
    X.setZero();
}
float Poly_Order4_Dim3_luminance_SGD::G() const {
    float v = X[0];
    int div[35];
    div[0] = 1;
    div[1] = 2;
...
float Poly_Order4_Dim3_luminance_SGD::g( const Eigen::VectorXd &s) const {
    float v = X[0];
    float c[35];
    c[0] = 1.0;
    c[1] = s[0];
...
void Poly_Order4_Dim3_luminance_SGD::sgd( const Eigen::VectorXd &s, Float v, const Float lr) {
    float c[35];
    c[0] = 1.0;
    c[1] = s[0];
    c[2] = s[1];
...
float Poly_Order4_Dim3_luminance_SGD::g_then_sgd( const Eigen::VectorXd &s, Float v, const Float lr) {
    // Evaluation g
    float g = X[0];
    float c[35];
    c[0] = 1.0;
...
void Poly_Order5_Dim3_luminance_SGD::reset() {
    X.setZero();
}
float Poly_Order5_Dim3_luminance_SGD::G() const {
    float v = X[0];
    int div[56];
    div[0] = 1;
    div[1] = 2;
...
float Poly_Order5_Dim3_luminance_SGD::g( const Eigen::VectorXd &s) const {
    float v = X[0];
    float c[56];
    c[0] = 1.0;
    c[1] = s[0];
...
void Poly_Order5_Dim3_luminance_SGD::sgd( const Eigen::VectorXd &s, Float v, const Float lr) {
    float c[56];
    c[0] = 1.0;
    c[1] = s[0];
    c[2] = s[1];
...
float Poly_Order5_Dim3_luminance_SGD::g_then_sgd( const Eigen::VectorXd &s, Float v, const Float lr) {
    // Evaluation g
    float g = X[0];
    float c[56];
    c[0] = 1.0;
...
void Poly_Order6_Dim3_luminance_SGD::reset() {
    X.setZero();
}
float Poly_Order6_Dim3_luminance_SGD::G() const {
    float v = X[0];
    int div[84];
    div[0] = 1;
    div[1] = 2;
...
float Poly_Order6_Dim3_luminance_SGD::g( const Eigen::VectorXd &s) const {
    float v = X[0];
    float c[84];
    c[0] = 1.0;
    c[1] = s[0];
...
void Poly_Order6_Dim3_luminance_SGD::sgd( const Eigen::VectorXd &s, Float v, const Float lr) {
    float c[84];
    c[0] = 1.0;
    c[1] = s[0];
    c[2] = s[1];
...
float Poly_Order6_Dim3_luminance_SGD::g_then_sgd( const Eigen::VectorXd &s, Float v, const Float lr) {
    // Evaluation g
    float g = X[0];
    float c[84];
    c[0] = 1.0;
...
void Poly_Order7_Dim3_luminance_SGD::reset() {
    X.setZero();
}
float Poly_Order7_Dim3_luminance_SGD::G() const {
    float v = X[0];
    int div[120];
    div[0] = 1;
    div[1] = 2;
...
float Poly_Order7_Dim3_luminance_SGD::g( const Eigen::VectorXd &s) const {
    float v = X[0];
    float c[120];
    c[0] = 1.0;
    c[1] = s[0];
...
void Poly_Order7_Dim3_luminance_SGD::sgd( const Eigen::VectorXd &s, Float v, const Float lr) {
    float c[120];
    c[0] = 1.0;
    c[1] = s[0];
    c[2] = s[1];
...
float Poly_Order7_Dim3_luminance_SGD::g_then_sgd( const Eigen::VectorXd &s, Float v, const Float lr) {
    // Evaluation g
    float g = X[0];
    float c[120];
    c[0] = 1.0;
